...
<body style="margin:0; padding:0; width:100%; background-color:#f5f7fa; font-family: Arial, sans-serif; line-height: 1.5; color: #2d3748;">

    <!-- Header Corporativo -->
    <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #1e3a5f 0%, #2d5a8c 100%);">
        <tr>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                    <tr>
                        <td align="center" class="mobile-padding" style="padding: 0 20px;">
                            ...
                            <p style="margin: 0; font-size: 14px; color: #d0dce8; font-style: italic;">
                                ¡Puedes Tenerlo Todo!
                            </p>
                        </td>
                    </tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background: #f5f7fa;">
        <tr>
            <td align="center" style="padding: 30px 0;">
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background: #fafbfc; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid #e8ecf1;">
                    <tr>
                        <td style="padding: 0;">
                            @yield('content')
                        </td>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                    <tr>
                        <td class="mobile-padding" style="padding: 0 20px;">
                            <!-- Footer Principal -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: #2c5282; border-radius: 12px 12px 0 0; margin-bottom: 0;">
                                <tr>
                                    <td class="mobile-padding" style="padding: 30px 25px;">
                                        <p style="margin: 0 0 20px; font-size: 16px; color: #ffffff; font-weight: bold; border-bottom: 2px solid #48bb78; padding-bottom: 8px; display: inline-block;">
                                            INFORMACIÓN DE CONTACTO
                                        </p>
                                        
                                        <p style="margin: 0 0 15px; font-size: 14px; color: #e6f0ff; line-height: 1.6;">
                            ...
                            <!-- Footer Inferior -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: #1e3a52; border-radius: 0 0 12px 12px;">
                                <tr>
